        ...
        <div class="col-md-2">
            <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="user.html"><i class="glyphicon glyphicon-list"></i> QL Người Dùng</a></li>
            ...
            <div class="content-box-large">
                ...
                <div class="panel-body">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"
                        ...
                        <tbody>
                        <c:forEach var="listTopic" items="${topicList}">
                            <tr class="odd gradeX">
                                <td>${listTopic.topicId}</td>
                                <c:if test="${listTopic.topicName.length() > 100 }"><td>${listTopic.topicName.substring(0, 100)}...</td></c:if>
                                <c:if test="${listTopic.topicName.length() <= 100 }"><td>${listTopic.topicName} </td></c:if>
                                <td class="center"> ${listTopic.authorId}</td>
                                <td class="center">${listTopic.catalogue.catalogueName}</td>
                                <td>${listTopic.createDay}</td>
                                <td>${listTopic.viewCount}</td>
                                <c:if test="${listTopic.topicStatus() == true}">
                                    <td>
                                        <form action="/topic/editStatus.html" method="post">
                                ...
                                <c:if test="${listTopic.topicStatus() == false}">
                                    <td>
                                        <form action="/topic/editStatus.html" method="post">
